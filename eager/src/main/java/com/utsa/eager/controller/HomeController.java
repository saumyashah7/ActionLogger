...
//    public ResponseEntity addMe(HttpServletRequest request) {
//		
...
//    }
//	
//	@RequestMapping(value= "/umet/{application}/{metric}/{num}/{id}") 
//    public ResponseEntity addumet(@PathVariable("application") String application, @PathVariable("metric") String metric, @PathVariable("num") int num, @PathVariable("id") int id,HttpServletRequest request) {
//		
//    //		String ipAddress =  request.getRemoteAddr();
//    //		User u=new User();
//    //		u.setMacaddress(ipAddress);
//    //		int id = userService.addorgetUser(u);
...
//	@RequestMapping(value= {"/alog/{application}/{metric}","/alog/{application}"})
//	public ResponseEntity addLLogget(@PathVariable(name="application") String application, @PathVariable(name="metric",required = false) String metric,HttpServletRequest request) throws JSONException {		
//		
//		int id=12;		
//		UsageMetric um=new UsageMetric();
//		um.setUserid(id);
...
//	}
//	
//	@RequestMapping(value= {"/gettToken/{id}"}, method=RequestMethod.GET)
//	@ResponseBody
//	public String gettToken(HttpServletRequest request,@PathVariable int id){
//		String token=null;
////		if(macaddress!=null) {
...
//	}
//	
//	@RequestMapping(value="/verToken/{id}/{token}", method=RequestMethod.GET)
//	@ResponseBody
//	public void verToken(@PathVariable(name="id") int id, @PathVariable(name="token") String tok, HttpServletRequest request){		
////		String ipAddress =  request.getRemoteAddr();
////		int id=userDAO.addorgetUser(ipAddress);
