...
@Controller
  ...
  public class LoginUserController {
    ...
    @GetMapping(value = "/sentlink")
      public String sentLink() throws Exception  {
        log("sent registration link");
        return "sentlink";
      }
    ...
    @GetMapping(value = "/login_normal")
      public String login_normal(Model model, String error, String logout) throws Exception  {
        log("login");
        if (error != null)
          model.addAttribute("error", "Your username and password is invalid.");
    ...
    @GetMapping(value = {"/", "/welcome"})
      public String welcome(@RequestParam(defaultValue="empty") String code,HttpServletRequest request, Model model, HttpSession session, Principal principal, Authentication authentication) throws Exception{
	log("welcome"); 
    ...
    @GetMapping(value = "/terminal")
      public String terminal(Model model,HttpServletRequest request, HttpSession session, Authentication authentication) throws Exception {
        log("terminal");
    ...
    @GetMapping(value = "/redirect")
      public String redirect(Model model, HttpSession session) throws Exception {
        model.addAttribute("ip", (String) session.getAttribute("mySessionAttribute"));
        log("redirect");
    ...
    @GetMapping(value = "/passwordReset")
      public String passwordReset(@RequestParam("user") String username, @RequestParam("token") String token) throws Exception{
        log("forgotPassword");
    ...
    @PostMapping(value = "/forgotPassword")
      public String resetPassword(Model model, @RequestParam("email") String email, HttpServletRequest request) throws Exception{
       log("forgotPassword");
